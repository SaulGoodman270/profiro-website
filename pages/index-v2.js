...
import Nav from "./components/Nav"; // Ujisti se, že cesta k Nav je správná
...
export default function Home() {
    ...
    return (
        <>
            <Head>
                <title>Profiro — Make Work Optional</title>
                <meta
                    name="description"
                    content="Stop working because you have to. Start building a plan to make work optional. Profiro is the privacy-first FIRE calculator and tracker for iOS."
                />
                <meta name="viewport" content="width=device-width, initial-scale=1" />
                <link rel="canonical" href="https://www.profiroapp.com/" />

                {/* Open Graph / Social Media */}
                <meta property="og:title" content="Profiro — Make Work Optional" />
                <meta
                    property="og:description"
                    content="Don't just track expenses. Plan your exit from the rat race. 100% Private & Manual control."
                />
